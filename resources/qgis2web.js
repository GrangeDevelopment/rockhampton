...
map.getView().fit([16637400.670730, -2740513.272912, 16819726.967996, -2623714.919097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rockhampton Market Map</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_ParcelAttributesLabel_83,
    colName: 'Address',
    zoom: 10,
    collapsed: true,
    map: map
